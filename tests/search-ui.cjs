...
const pending=[];
const context=vm.createContext({document:{querySelector:el,addEventListener(){},getElementById:()=>null,body:{classList:{add(){},remove(){},toggle(){}}}},addEventListener(){},innerWidth:1440,innerHeight:900,console,Map,JSON,Date,Intl,setInterval:()=>0,clearInterval(){},requestAnimationFrame:f=>f(0),matchMedia:()=>({matches:true}),performance,
